...
// partials path
paths.partials.push(paths.src + 'javascripts/app/partials/**/*');
...
paths.scripts = {
  ...
  app: [
    ...
    paths.tmp + 'javascripts/app/partials/**/*.js', // dynamically generated by gulp task (ng-templates)
...
gulp.task('jade-templates', function(){
  return gulp.src(paths.partials + '.jade')
    .pipe(plugins.jade())
    .pipe(gulp.dest(paths.tmp + 'javascripts/app/partials/'));
});
// html partials
gulp.task('html-templates', ['jade-templates'], function(){
  return gulp.src(paths.partials + '.html')
    .pipe(gulp.dest(paths.tmp + 'javascripts/app/partials/'));
});
// angular partials
gulp.task('ng-templates', ['html-templates'], function(){
  return gulp.src(paths.tmp + 'javascripts/app/partials/**/*')
