...
paths.scripts = {
  vendor: [
    ...
    paths.src + 'vendor/jquery-details/jquery.details.js',
  ...
  app: [
    paths.tmp + 'javascripts/app/js/constants.js', // dynamically generated by gulp task
    paths.tmp + 'javascripts/app/partials/**/*', // dynamically generated by gulp task
    paths.src + 'javascripts/app/js/app.js',
    paths.src + 'javascripts/app/js/**/*.js'
  ],
  moj: [
    paths.src + 'javascripts/moj.Helpers.js',
    paths.src + 'javascripts/modules/*'
  ]
};
...
gulp.task('default', function() {
  runSequence('clean-pre', ['sass', 'fonts', 'images', 'vendor', 'js-compile']);
});
