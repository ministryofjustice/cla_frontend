...
from session_security.middleware import SessionSecurityMiddleware as BaseSessionSecurityMiddleware
...
PASSIVE_QUERYSTRING = getattr(settings, "SESSION_SECURITY_PASSIVE_QUERYSTRING", None)
